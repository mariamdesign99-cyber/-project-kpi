...
import { KpiAnalyticsView } from '../components/KpiAnalyticsView.tsx';
import { generateMockKpiData, performAiAnalysis } from '../services/aiAnalysisService.ts';
import { generateAiAnalysis } from '../services/geminiService.ts';
import { GeminiText, AnalysisData } from '../components/KpiCard.tsx';
import { type ChatMessage, type Kpi } from '../App.tsx';
import { DataUpdate } from '../components/DataUpdate.tsx';
import { KpiCalculator } from '../components/KpiCalculator.tsx';

// Type alias for KPI base configuration
type KpiConfig = {
    id: string;
    title: string;
