...
import { generatePdf } from '../services/reportService.ts';
import { DownloadIcon, TrendingUpIcon, TrendingDownIcon, SparklesIcon, LightbulbIcon, MessageCircleIcon } from './icons.tsx';
